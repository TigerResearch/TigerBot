...
- [7/08/2023] TigerBot 2013.07 (V2) release :fire: 
	...
	- tigerbot-7b 开启搜索模式，对接主流中英文搜索引擎，和结构化工具（如天气，股市，计算器等），打开LLM+search的应用场景，chat-api也同步开放；[<a href="https://www.tigerbot.com/chat">TigerBot-7b upgraded with search mode :earth_asia:</a>]
